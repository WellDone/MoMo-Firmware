;Name: test_bus_master_checksum10x
;Type: executive
;Attach Slave:8, responder_checksum_10x.py
...
;sending an rpc and seeing if it sends correctly and that the bus master 
;recovers from an arbitrary number of checksum errors (10 retries in this case)

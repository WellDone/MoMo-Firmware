...
cfile = '/Users/timburke/Projects/MoMo-Firmware(personal)/pcb/momo_modular/combined_controller/battery_controller.brd'
...
cbom_ext = cboard.export_bom('EXTPOWER','/Users/timburke/Dropbox/Shared - Other People/MoMo Core Hardware/combined_controller/external_power.csv')
